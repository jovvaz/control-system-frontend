...
export function CadastroProdutoPage() {
    ...
    return (
        <div>
            ...
            {/* O FORMULÁRIO PRINCIPAL COMEÇA SÓ DEPOIS DA SEÇÃO DE RECEITA */}
            <form onSubmit={handleCriarProduto}>
                ...
                {/* O BOTÃO DE SUBMIT AGORA ESTÁ AQUI, ANTES DO FIM DO FORM */}
                <br />
                <button type="submit">Cadastrar Produto</button>
            </form>
            
            {/* A SEÇÃO DE RECEITA FOI MOVIDA PARA FORA E PARA BAIXO DO FORMULÁRIO */}
            {formTipo === 'PRODUTO_ACABADO' && (
                <div className="recipe-section" style={{ marginTop: '20px', border: '1px solid #555' }}>
                    ...
                    <div>
                        ...
                        <button type="button" onClick={handleAddComponente}>
